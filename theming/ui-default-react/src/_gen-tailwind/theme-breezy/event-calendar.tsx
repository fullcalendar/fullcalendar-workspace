...
const mutedHoverButtonClass = joinClassNames(
  'hover:bg-(--fc-breezy-muted) focus-visible:bg-(--fc-breezy-muted)',
  'focus-visible:outline-2',
  'outline-(--fc-breezy-primary)',
)
  ...
  return (
    <FullCalendar
      ...
      dayCellTopInnerClass={(data) => [
        ...
        data.isToday
          ...
          : joinClassNames(
              'rounded-e-sm',
              data.isNarrow ? 'px-1' : 'px-2',
              data.hasNavLink && 'hover:bg-(--fc-breezy-muted) focus-visible:bg-(--fc-breezy-muted)',
              data.isOther
      ...
      popoverCloseClass={[
        ...
        'hover:bg-(--fc-breezy-muted) focus-visible:bg-(--fc-breezy-muted) focus-visible:outline-2 outline-(--fc-breezy-primary)',
      ]}
      ...
      inlineWeekNumberClass={(data) => [
        ...
        'border-b border-(--fc-breezy-strong-border)',
        'border-s border-s-(--fc-breezy-border)',
        data.isNarrow
          ? `p-0.5 ${xxsTextClass}`
          : 'p-1.5 text-xs',
        data.hasNavLink
          ? 'hover:bg-(--fc-breezy-muted) focus-visible:bg-(--fc-breezy-muted) -outline-offset-1'
          : 'hover:bg-(--fc-breezy-muted)',
      ]}
