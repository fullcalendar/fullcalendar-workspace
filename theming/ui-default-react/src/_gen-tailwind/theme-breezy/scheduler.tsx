...
import { EventCalendar, mutedFgPressableGroupClass, outlineWidthFocusClass, primaryOutlineColorClass, mutedHoverPressableClass, chevronDown } from './event-calendar.js'
      ...
      views={{
        ...
        timeline: {
          ...
          rowMoreLinkClass: [
            ...
            '[background:linear-gradient(var(--fc-breezy-strong),var(--fc-breezy-strong))_var(--fc-breezy-background)] hover:[background:linear-gradient(var(--fc-breezy-stronger),var(--fc-breezy-stronger))_var(--fc-breezy-background)] active:[background:linear-gradient(var(--fc-breezy-strongest),var(--fc-breezy-strongest))_var(--fc-breezy-background)] print:bg-white',
          ],
