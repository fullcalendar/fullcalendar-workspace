      ...
      views={{
        ...
        timeline: {
          ...
          rowMoreLinkClass: [
            ...
            '[background:linear-gradient(var(--fc-forma-strong),var(--fc-forma-strong))_var(--fc-forma-background)] hover:[background:linear-gradient(var(--fc-forma-stronger),var(--fc-forma-stronger))_var(--fc-forma-background)] active:[background:linear-gradient(var(--fc-forma-strongest),var(--fc-forma-strongest))_var(--fc-forma-background)] print:bg-white',
          ],
