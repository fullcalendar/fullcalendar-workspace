...
import { EventCalendar, mutedFgPressableGroupClass, outlineWidthFocusClass, tertiaryOutlineColorClass, mutedHoverPressableClass, secondaryPressableClass, secondaryClass, chevronDown } from './event-calendar.js'
      ...
      views={{
        ...
        timeline: {
          ...
          rowMoreLinkClass: [
            ...
            '[background:linear-gradient(var(--fc-monarch-strong),var(--fc-monarch-strong))_var(--fc-monarch-background)] hover:[background:linear-gradient(var(--fc-monarch-stronger),var(--fc-monarch-stronger))_var(--fc-monarch-background)] active:[background:linear-gradient(var(--fc-monarch-strongest),var(--fc-monarch-strongest))_var(--fc-monarch-background)] print:bg-white',
          ],
