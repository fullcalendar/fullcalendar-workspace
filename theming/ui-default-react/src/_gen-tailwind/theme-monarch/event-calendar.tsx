...
export const tertiaryOutlineColorClass = outlineColorClass
...
export function chevronDown(className?: string) {
  return (
    <svg className={className} xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='80 -880 800 800' fill='currentColor'>
      <path d='M480-304 240-544l56-56 184 184 184-184 56 56-240 240Z' />
    </svg>
  )
}
