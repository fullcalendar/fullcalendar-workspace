...
import { EventCalendar, xxsTextClass } from './event-calendar.js'
  ...
  return (
    <EventCalendar
      ...
      resourceExpanderContent={(data) => data.isExpanded
        ? minusSquare('size-4 not-group-hover:opacity-65')
        : plusSquare('size-4 not-group-hover:opacity-65')}
      ...
      views={{
        ...
        timeline: {
          ...
          rowMoreLinkClass: [
            ...
            '[background:linear-gradient(var(--fc-classic-strong),var(--fc-classic-strong))_var(--fc-classic-background)] print:bg-white',
          ],
          ...
          nowIndicatorHeaderClass: [
            ...
            'border-t-[6px] border-t-(--fc-classic-now)',
          ],
          nowIndicatorLineClass: 'border-s border-s-(--fc-classic-now)',
          ...userViews?.timeline,
        },
      }}
      {...restOptions}
