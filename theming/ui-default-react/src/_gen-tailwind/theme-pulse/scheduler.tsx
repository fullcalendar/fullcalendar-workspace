...
import { EventCalendar, mutedFgPressableGroupClass, outlineWidthFocusClass, tertiaryOutlineColorClass, mutedHoverPressableClass, chevronDown } from './event-calendar.js'
      ...
      views={{
        ...
        timeline: {
          ...
          rowMoreLinkClass: [
            ...
            '[background:linear-gradient(var(--fc-pulse-strong),var(--fc-pulse-strong))_var(--fc-pulse-background)] hover:[background:linear-gradient(var(--fc-pulse-stronger),var(--fc-pulse-stronger))_var(--fc-pulse-background)] active:[background:linear-gradient(var(--fc-pulse-strongest),var(--fc-pulse-strongest))_var(--fc-pulse-background)] print:bg-white',
          ],
