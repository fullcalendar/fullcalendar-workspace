...
import FullCalendar, { type CalendarOptions, type DayCellData } from '@fullcalendar/react'
  ...
  return (
    <FullCalendar
      height={height}
        ...
        eventClass={(data) => cn(
          data.isSelected
            ? ['outline-3', data.isDragging && 'shadow-lg']
        ...
        columnEventClass={(data) => cn(
          ...
          data.isStart && ['border-t rounded-t-lg', data.isNarrow ? 'mt-px' : 'mt-0.5'],
          data.isEnd && ['border-b rounded-b-lg', data.isNarrow ? 'mb-px' : 'mb-0.5'],
        )}
        ...
        singleMonthHeaderClass={(data) => cn(
          data.multiMonthColumnCount > 1 ? 'pb-2' : 'py-1 border-b bg-background',
          'items-center',
        )}
