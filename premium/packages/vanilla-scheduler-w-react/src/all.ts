import { Calendar as BareCalendar } from '@fullcalendar/vanilla-w-react/public-components'
import { CalendarOptions, PluginDefInput } from '@fullcalendar/vanilla-w-react/public-api'
import interactionPlugin from '@fullcalendar/vanilla-w-react/interaction'
import dayGridPlugin from '@fullcalendar/vanilla-w-react/daygrid'
import timeGridPlugin from '@fullcalendar/vanilla-w-react/timegrid'
import listPlugin from '@fullcalendar/vanilla-w-react/list'
import multiMonthPlugin from '@fullcalendar/vanilla-w-react/multimonth'
