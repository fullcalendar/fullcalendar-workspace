...
import type { EventChangeData, EventAddData, EventRemoveData, EventRenderRange } from '../../api-type-deps'
...
import { diffDates } from '@full-ui/headless-calendar'
import { enableCursor, disableCursor } from '../../util/dom-manip'
import { getElEventRange } from '../../component-util/event-rendering'
import type { eventDragMutationMassager } from '../../calendar-utils'
import { Interaction } from '../../interactions/Interaction'
import type { InteractionSettings } from '../../interactions/interaction-settings'
import { interactionSettingsStore } from '../../interactions/interaction-settings'
import type { EventDropTransformers } from '../../calendar-utils'
import type { CalendarContext } from '../../CalendarContext'
import { buildEventApis } from '../../api/event-api-utils'
    ...
    if (this.isDragging) {
      ...
      if (validMutation) {
        ...
        // dropped in different calendar
          ...
          let eventRemoveData: EventRemoveData = {
            event: eventApi,
