...
/*!
FullCalendar Scheduler v1.3.0-beta
...
FC.schedulerVersion = "1.3.0-beta";
...
ScrollFollower = (function() {
  ...
  function ScrollFollower(scroller) {
    this.scroller = scroller;
    this.sprites = [];
    if (FC.isTouchEnabled) {
      this.isForcedRelative = true;
    }
    scroller.on((FC.isTouchEnabled ? 'scrollEnd' : 'scroll'), (function(_this) {
      return function() {
  ...
  ScrollFollower.prototype.clearForce = function() {
    var j, len, ref, results, sprite;
    if (this.isForcedRelative && !FC.isTouchEnabled) {
