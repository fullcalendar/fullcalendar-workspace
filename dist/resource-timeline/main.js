/*!
@fullcalendar/resource-timeline v4.0.1
...
(function (global, factory) {
    ...
    */
    ...
    var SpreadsheetHeader = /** @class */ (function (_super) {
        ...
        SpreadsheetHeader.prototype.applyColWidths = function () {
            var _this = this;
            this.colWidths.forEach(function (width, colIndex) {
                if (typeof width === 'number') {
                    _this.colEls[colIndex].style.width = width + 'px';
                }
            });
        };
    ...
    var Spreadsheet = /** @class */ (function (_super) {
        ...
        function Spreadsheet(context, headParentEl, bodyParentEl) {
            ...
            _this.header.emitter.on('colwidthchange', function (colWidths) {
                _this.applyBodyColWidths(colWidths);
            });
        ...
        Spreadsheet.prototype.applyBodyColWidths = function (colWidths) {
            var _this = this;
            colWidths.forEach(function (colWidth, colIndex) {
                if (typeof colWidth === 'number') {
                    _this.bodyColEls[colIndex].style.width = colWidth + 'px';
                }
            });
        };
        return Spreadsheet;
