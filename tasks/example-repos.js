...
gulp.task('example-repo:bump', function(done) {
  ...
  const coreSemVer = require('../package.json').dependencies.fullcalendar
  const schedulerSemVer = '^' + argv.version
  ...
  return gulp.src(argv.dir + '/package.json')
    .pipe(
      modify(function(content) {
        ...
        obj.dependencies['fullcalendar-scheduler'] = schedulerSemVer
